...
Page({
  data: {
    sdkReady: false,
    componentsData: config.devConfig.mock.componentsData["component-template"],
  },
  onLoad(query) {
    ...
    dd.loadPlugin({
      ...
      success: () => {
        this.worktab = requirePlugin(
          `dynamic-plugin://${config.devConfig.sdk.miniAppId}`
        );
        const plugin = requirePlugin("myPlugin");

        plugin.registerAttendSdk(this.worktab);
